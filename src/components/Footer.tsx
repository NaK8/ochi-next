...
function Footer() {
  return (
    <footer
      data-scroll
      data-scroll-section
      className="size-full rounded-t-3xl pb-8 pt-20"
    >
        ...
        <div>
          ...
          <div className="flex flex-col justify-start md:flex-row">
            <div className="w-full md:w-1/2">
              ...
              />
              <HoverLinks
                items={["202-1965 W 4th Ave", "Vancouver, Canada"]}
                color="black"
                heading="L:"
              />
              <HoverLinks
                items={["30 Chukarina St", "Lviv, Ukraine"]}
                color="black"
              />
              <HoverLinks
                items={["hello@ochi.design"]}
                color="black"
                heading="E:"
              />
            </div>
      ...
      <div className="grid grid-cols-1 gap-y-5 px-8 pt-10 md:grid-cols-3 md:gap-y-0 md:px-20">
        <div>
          <svg
            width="72"
            height="30"
